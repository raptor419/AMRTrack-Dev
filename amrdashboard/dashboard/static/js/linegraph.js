...
d3.tsv("http://127.0.0.1:8000/static/linegraph.tsv", function(error, data) {
    console.log(data);
  ...
  var categories = color.domain().map(function(name) { // Nest the data into an array of objects with new keys
    ...
    return {
      ...
      visible: (name === "Unemployment" ? false : true) // "visible": all false except for economy which is true.
    };
  });
